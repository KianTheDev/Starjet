...
public class ParticleSpell extends ParticleProjectile
{
	...
	public ParticleSpell(double xp, double yp, double zp, ParticleTypeEnum effect, Vector vector, World world, int maxAge, float size, double damage, Ship owner, Sound sound, int data, ParticleTypeEnum effect2, int data2, float size2, boolean collision)
	{
